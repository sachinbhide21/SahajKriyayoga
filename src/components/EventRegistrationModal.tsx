...
export const EventRegistrationModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="bg-white dark:bg-slate-900 rounded-3xl max-w-md w-full p-6 border border-amber-300 dark:border-slate-700 shadow-2xl relative space-y-4">
        ...
        {!registered ? (
          <>
            ...
            >
              ...
              <div className="p-3 rounded-xl bg-amber-50 dark:bg-slate-800 text-[11px] text-amber-900 dark:text-amber-200">
