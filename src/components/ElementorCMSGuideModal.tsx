...
export const ElementorCMSGuideModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/85 backdrop-blur-md animate-fade-in">
      <div className="bg-white rounded-3xl max-w-3xl w-full p-6 sm:p-8 border border-amber-300 shadow-2xl relative max-h-[88vh] overflow-y-auto space-y-6">
        ...
        {/* Header */}
        <div className="flex items-center space-x-3 border-b border-amber-200 pb-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200/60 ">
              <strong className="block text-amber-900 font-bold mb-0.5">Header & Sticky Nav Template</strong>
              <p className="text-slate-600 ">Elementor Theme Builder Header set to Entire Site. Uses Elementor Nav Menu widget + Animated Ticker for Announcements.</p>
            </div>

            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200/60 ">
              <strong className="block text-amber-900 font-bold mb-0.5">Guru Parampara Loop Grid Template</strong>
              <p className="text-slate-600 ">Elementor Loop Item for CPT 'guru_parampara'. Card layout with ACF portrait image, quote, and hover animations.</p>
            </div>

            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200/60 ">
              <strong className="block text-amber-900 font-bold mb-0.5">Events Calendar Loop Grid Template</strong>
              <p className="text-slate-600 ">Custom CPT 'ashram_events' displaying category badges, start/end dates, and Elementor Popup trigger for registration.</p>
            </div>

            <div className="p-3 rounded-xl bg-amber-50 border border-amber-200/60 ">
              <strong className="block text-amber-900 font-bold mb-0.5">Footer & Social Template</strong>
              <p className="text-slate-600 ">Global Footer widget featuring Ashram branch links, 80G tax benefit notice, and Mailchimp/Newsletter integration.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <pre className="p-4 rounded-xl bg-white text-amber-700 font-mono text-[11px] overflow-x-auto border border-amber-200 max-h-48">
            {acfSchemaJSON}
          </pre>
        </div>

        {/* Section 3: Scalability */}
        <div className="p-4 rounded-2xl bg-amber-100/60 text-xs text-slate-700 space-y-2 border border-amber-200/60">
          <strong className="block text-amber-900 font-bold">Future Scalability & Multi-Language Recommendations:</strong>
