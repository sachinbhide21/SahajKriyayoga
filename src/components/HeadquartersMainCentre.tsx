...
export const HeadquartersMainCentre: React.FC = () => {
  ...
  return (
    <section
      ...
      className="py-16 bg-[#FAF8F5] dark:bg-slate-950 transition-colors duration-300 relative"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="relative h-[480px] sm:h-[560px] lg:h-[620px] w-full overflow-hidden">
            ...
            <div className="absolute top-6 left-6 right-6 flex flex-wrap items-center justify-between gap-3 z-10">
              ...
              <div className="flex items-center space-x-2">
                <span className="px-3.5 py-1 rounded-full bg-slate-900/80 backdrop-blur-md text-amber-200 text-xs font-bold border border-amber-500/30">
                  Est. 1971
                </span>
                <span className="px-3.5 py-1 rounded-full bg-slate-900/80 backdrop-blur-md text-amber-300 text-xs font-bold border border-amber-500/30 flex items-center gap-1">
            ...
            <div className="absolute bottom-8 left-6 right-6 sm:left-10 sm:right-10 lg:left-12 lg:right-12 z-10 space-y-4 max-w-4xl">
              <div className="inline-flex items-center space-x-2 text-amber-300 text-xs font-bold uppercase tracking-wider bg-amber-950/80 backdrop-blur-md px-3.5 py-1 rounded-full border border-amber-500/40">
              ...
              <p className="text-sm sm:text-base lg:text-lg text-amber-100/90 font-medium leading-relaxed max-w-3xl drop-shadow">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  className="px-6 py-3 rounded-full text-xs sm:text-sm font-bold text-amber-100 bg-amber-950/80 hover:bg-amber-900 backdrop-blur-md border border-amber-500/50 shadow-lg transition-all duration-300 flex items-center gap-2"
                >
                ...
                <a
                  href="#hq-gallery"
                  className="px-5 py-3 rounded-full text-xs sm:text-sm font-bold text-slate-200 bg-slate-900/80 hover:bg-slate-800 backdrop-blur-md border border-slate-700 shadow-md transition-colors flex items-center gap-2"
                >
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-10 shadow-xl border border-amber-200 dark:border-amber-500/20 relative overflow-hidden">
          <div className="absolute -top-12 -right-12 w-64 h-64 bg-amber-500/10 rounded-full blur-3xl pointer-events-none" />

          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-8 space-y-4">
              <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-bold uppercase tracking-wider border border-amber-300/50">
                <Crown className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
                <span>Headquarters Overview</span>
              </div>

              <h2 className="text-2xl sm:text-4xl font-serif font-extrabold text-slate-900 dark:text-amber-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-amber-50/80 dark:bg-slate-800 border border-amber-200/80 dark:border-slate-700 text-center space-y-1">
                  <p className="text-2xl font-serif font-black text-amber-900 dark:text-amber-300">1971</p>
                  <p className="text-xs font-bold text-slate-600 dark:text-slate-400">Established Year</p>
                </div>
                <div className="p-4 rounded-2xl bg-amber-50/80 dark:bg-slate-800 border border-amber-200/80 dark:border-slate-700 text-center space-y-1">
                  <p className="text-2xl font-serif font-black text-amber-900 dark:text-amber-300">Belpahari</p>
                  <p className="text-xs font-bold text-slate-600 dark:text-slate-400">Jhargram, West Bengal</p>
                </div>
                <div className="p-4 rounded-2xl bg-amber-50/80 dark:bg-slate-800 border border-amber-200/80 dark:border-slate-700 text-center space-y-1">
                  <p className="text-2xl font-serif font-black text-amber-900 dark:text-amber-300">Kriya Yoga</p>
                  <p className="text-xs font-bold text-slate-600 dark:text-slate-400">Authentic Lineage</p>
                </div>
              </div>
            </div>

            <div className="lg:col-span-4 bg-gradient-to-br from-amber-900 to-slate-900 text-amber-100 p-6 rounded-2xl border border-amber-500/30 space-y-4 shadow-lg">
              <h3 className="text-lg font-serif font-bold text-amber-300 flex items-center gap-2">
                <MapPin className="w-5 h-5 text-amber-400" />
                <span>Headquarters Location</span>
              </h3>

              <div className="text-xs space-y-2 text-amber-100/90 leading-relaxed">
                <p className="font-bold text-white">Brahmarshi Satyananda Sannyas Ashram</p>
                <p>Gadrasini Pahar, Belpahari</p>
                <p>Jhargram District, West Bengal - 721501, India</p>
              </div>

              <div className="pt-2 space-y-2 border-t border-amber-500/30 text-xs">
            ...
            {LANDMARK_ALBUMS.map((landmark) => {
              ...
              return (
                <div
                  ...
                  className="group cursor-pointer rounded-3xl overflow-hidden bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-md hover:shadow-2xl transition-all duration-500 flex flex-col justify-between transform hover:-translate-y-1.5"
                >
                  <div>
                    {/* Cover Image Frame */}
                    <div className="relative h-52 w-full overflow-hidden bg-slate-950">
                      ...
                      <span className="absolute top-3 right-3 px-3 py-1 rounded-full bg-slate-900/80 backdrop-blur-md text-amber-300 text-[11px] font-bold border border-amber-500/40 flex items-center gap-1 shadow-md">
                        {landmark.isVideo ? (
                          <>
                      ...
                      <div className="absolute bottom-3 left-3 right-3">
                        <p className="text-[11px] font-bold text-amber-200 drop-shadow line-clamp-1">
                          {landmark.subtitle}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="p-5 space-y-2">
                      <h3 className="text-base font-serif font-bold text-slate-900 dark:text-amber-100 group-hover:text-amber-700 dark:group-hover:text-amber-300 transition-colors leading-snug">
                        {landmark.title}
                      </h3>
                  ...
                  <div className="px-5 pb-5 pt-0">
                    <button
                      type="button"
                      className="w-full py-2.5 px-4 rounded-xl bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-200 group-hover:bg-amber-400 group-hover:text-slate-950 font-bold text-xs transition-colors duration-300 flex items-center justify-center gap-2 border border-amber-300/50 dark:border-amber-500/30"
                    >
                      {landmark.isVideo ? (
                        <>
        ...
        <div id="hq-video-tour" className="bg-slate-900 rounded-3xl p-6 sm:p-8 border border-amber-500/40 shadow-2xl space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-amber-500/20 pb-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-xs font-bold text-amber-100 bg-amber-950/80 hover:bg-amber-900 border border-amber-500/50 shadow-md transition-colors"
            >
          ...
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden border border-amber-500/30 bg-slate-950 shadow-2xl">
            <iframe
        ...
        <div className="bg-amber-900/10 dark:bg-slate-900/80 rounded-3xl p-8 sm:p-12 border border-amber-300/40 dark:border-slate-800 space-y-6">
          <div className="max-w-3xl space-y-3">
            <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-amber-200 dark:bg-amber-950 text-amber-900 dark:text-amber-300 text-xs font-bold uppercase tracking-wider border border-amber-300/50">
              <Crown className="w-3.5 h-3.5 text-amber-700 dark:text-amber-400" />
              <span>Headquarters Significance</span>
            </div>

            <h2 className="text-2xl sm:text-4xl font-serif font-bold text-slate-900 dark:text-amber-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700 space-y-3 shadow-md">
        ...
        {/* 5. Daily Activities */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-10 border border-slate-200 dark:border-slate-800 space-y-6 shadow-md">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-6">
            <div>
              <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-bold uppercase tracking-wider mb-2">
                <Clock className="w-3.5 h-3.5 text-amber-600" />
                <span>Ashram Routine</span>
              </div>
              <h2 className="text-2xl sm:text-3xl font-serif font-bold text-slate-900 dark:text-amber-100">
                Daily Ashram Activities
              </h2>
            </div>
            <span className="text-xs font-bold text-amber-800 dark:text-amber-300 bg-amber-50 dark:bg-slate-800 px-3.5 py-1.5 rounded-full border border-amber-200 dark:border-slate-700">
              Open to All Devotees & Seekers
            </span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">05:00 AM - 06:30 AM</span>
                <Sun className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Mangal Arati & Chanting</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">Morning prayers, Vedic chanting, and Guru Vandana at Sri Gita Mandir.</p>
            </div>

            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">07:00 AM - 08:30 AM</span>
                <Flame className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Kriya Yoga Meditation</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">Guided Kriya Yoga pranayama and silent meditation in the forest kutir.</p>
            </div>

            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">10:00 AM - 11:30 AM</span>
                <BookOpen className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Bhagavad Gita Classes</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">In-depth shloka study and practical spiritual philosophy at Sri Gita Mandir.</p>
            </div>

            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">12:30 PM - 02:00 PM</span>
                <Heart className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Guru Seva & Mahaprasadam</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">Community kitchen seva, sanctified vegetarian meals and rest.</p>
            </div>

            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">05:00 PM - 06:30 PM</span>
                <Users className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Bhagwat Katha & Evening Satsang</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">Spiritual discourses, devotional bhajans, and satsang by Paramhans Gyanananda Maharaj.</p>
            </div>

            <div className="p-5 rounded-2xl bg-amber-50/60 dark:bg-slate-800/60 border border-amber-200/60 dark:border-slate-700/60 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-amber-800 dark:text-amber-400">07:00 PM - 08:00 PM</span>
                <Flame className="w-4 h-4 text-amber-600" />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-amber-100">Evening Meditation & Sandhya Arati</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300">Deep evening meditation followed by arati and peaceful silent retreat.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
              <span className="px-3 py-1 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 text-[11px] font-bold">
                July / Ashadha Purnima
              </span>
              <h3 className="text-lg font-serif font-bold text-slate-900 dark:text-amber-100">Guru Purnima Mahotsav</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 dark:text-amber-100">Swami Jagadananda Giri Guru Maharaj Aavirbhav Divas</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 dark:text-amber-100">Narmada Jayanti Mahotsav</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 dark:text-amber-100">Shri Krishna Janmashtami Mahotsav</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            <div className="p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-md">
              ...
              <h3 className="text-lg font-serif font-bold text-slate-900 dark:text-amber-100">Maha Shivaratri Sadhana Camp</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Visiting Details */}
          <div className="lg:col-span-6 bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 space-y-6 shadow-md">
            <div>
              <div className="inline-flex items-center space-x-2 px-3.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-bold uppercase tracking-wider mb-2">
            ...
            <div className="space-y-4 text-xs text-slate-700 dark:text-slate-300 leading-relaxed">
              <div className="p-4 rounded-xl bg-amber-50/80 dark:bg-slate-800/80 border border-amber-200 dark:border-slate-700 space-y-1">
                <p className="font-bold text-slate-900 dark:text-amber-100 text-sm">📍 Full Address:</p>
                <p>Brahmarshi Satyananda Sannyas Ashram, Gadrasini Pahar, Belpahari, Jhargram District, West Bengal - 721501, India.</p>
              </div>

              <div className="space-y-2">
                <p className="font-bold text-slate-900 dark:text-amber-100">🚉 By Train:</p>
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 px-5 py-2.5 rounded-full text-xs font-bold text-amber-100 bg-amber-900 hover:bg-amber-800 transition-colors shadow-md flex items-center justify-center gap-1.5"
              >
                <Navigation className="w-4 h-4 text-amber-400" />
                <span>Get Directions</span>
              </a>
          ...
          <div className="lg:col-span-6 bg-slate-900 rounded-3xl p-6 border border-amber-500/30 space-y-4 shadow-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <MapPin className="w-5 h-5 text-amber-400" />
            ...
            <div className="w-full h-[380px] rounded-2xl overflow-hidden border border-amber-500/30 relative">
              <iframe
            ...
            <div className="p-3 rounded-xl bg-slate-950 text-xs text-amber-200/90 flex items-center justify-between">
        ...
        <div className="bg-gradient-to-r from-amber-950 via-slate-900 to-amber-900 rounded-3xl p-8 sm:p-12 text-amber-50 shadow-2xl border border-amber-500/40 relative overflow-hidden text-center space-y-6">
          <div className="max-w-2xl mx-auto space-y-3 relative z-10">
            ...
            <h2 className="text-3xl sm:text-5xl font-serif font-black text-amber-100">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-3.5 rounded-full text-sm font-bold text-amber-100 bg-amber-950/80 hover:bg-amber-900 border border-amber-500/50 shadow-xl transition-all duration-300 flex items-center gap-2"
            >
              <Navigation className="w-4 h-4 text-amber-400" />
              <span>Get Directions</span>
            </a>
      ...
      {activeAlbum && (
        <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-xl flex flex-col justify-between p-4 sm:p-8 animate-fade-in overflow-y-auto">
          
          <div className="max-w-6xl mx-auto w-full my-auto space-y-6 bg-slate-900/90 border border-amber-500/30 rounded-3xl p-6 sm:p-8 shadow-2xl">
            ...
            <div className="flex items-center justify-between border-b border-amber-500/20 pb-4">
              <div>
                ...
                <h3 className="text-xl sm:text-3xl font-serif font-black text-amber-100">
              ...
              <button
                ...
                className="p-2.5 rounded-full bg-slate-800 text-slate-200 hover:text-amber-300 hover:bg-slate-700 transition-colors"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-full text-xs font-bold transition-all duration-300 flex items-center gap-1.5 ${
                      activeAlbum === alb.id
                        ...
                        : 'bg-slate-800 text-amber-200 border border-slate-700 hover:border-amber-500/50'
                    }`}
                  >
            ...
            {activeAlbum === 'Ashram & Gadrasini Hill View' && (
              <div className="bg-slate-950 p-4 sm:p-5 rounded-2xl border border-amber-500/40 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-amber-500/20 pb-3">
                  <div className="flex items-center space-x-2">
                    <Video className="w-4 h-4 text-amber-400" />
                    <span className="text-sm font-bold text-amber-100">Featured Video: Ashram and Gadrasini Hill View</span>
                  </div>
                  <a
                    href="https://drive.google.com/file/d/1QeG9etg71UQzUqBzPm4KnDuf2FnT6Knu/view?usp=sharing"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-bold text-amber-300 bg-amber-950/80 border border-amber-500/40 hover:bg-amber-900 transition-colors"
                  >
                    <span>Open in Google Drive</span>
                    <ExternalLink className="w-3 h-3" />
                  </a>
                </div>
                <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-amber-500/30 bg-slate-900">
                  <iframe
                    src="https://drive.google.com/file/d/1QeG9etg71UQzUqBzPm4KnDuf2FnT6Knu/preview"
                    title="Ashram and Gadrasini Hill View Video"
                    width="100%"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-h-[60vh] overflow-y-auto pr-2">
              {albumPhotos.map((photo, index) => (
                <div
                  ...
                  className="group cursor-pointer rounded-2xl overflow-hidden bg-slate-950 border border-amber-500/20 hover:border-amber-400/60 transition-all duration-300 flex flex-col justify-between"
                >
                  <div className="relative h-56 bg-slate-950 flex items-center justify-center p-2 overflow-hidden">
                    <img
                      src={photo.imageUrl}
                      alt={photo.alt}
                      referrerPolicy="no-referrer"
                    ...
                    <div className="absolute top-3 right-3 p-2 rounded-full bg-slate-900/80 text-amber-300 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Maximize2 className="w-4 h-4" />
                    </div>
                  </div>

                  <div className="p-4 space-y-1 bg-slate-900">
                    <h4 className="text-sm font-serif font-bold text-amber-100 group-hover:text-amber-300 transition-colors line-clamp-1">
                      {photo.title}
                    </h4>
            ...
            <div className="pt-2 border-t border-amber-500/20 text-center text-xs text-amber-300/80 font-medium">
      ...
      {lightboxIndex !== null && albumPhotos.length > 0 && (
        <div className="fixed inset-0 z-50 bg-slate-950/95 backdrop-blur-2xl flex flex-col justify-between p-4 sm:p-8 animate-fade-in">
          ...
          <div className="flex items-center justify-between text-white z-10">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xs text-amber-200/90 font-semibold hidden sm:inline">
          ...
          <div className="relative flex-1 flex items-center justify-center my-4 overflow-hidden">
            ...
            <button
              ...
              className="absolute left-2 sm:left-6 z-20 p-3 rounded-full bg-slate-900/80 text-amber-300 hover:bg-amber-400 hover:text-slate-950 transition-colors shadow-2xl border border-amber-500/30"
            >
            ...
            <button
              ...
              className="absolute right-2 sm:right-6 z-20 p-3 rounded-full bg-slate-900/80 text-amber-300 hover:bg-amber-400 hover:text-slate-950 transition-colors shadow-2xl border border-amber-500/30"
            >
          ...
          <div className="bg-slate-900/90 border border-amber-500/30 rounded-2xl p-4 sm:p-5 text-center max-w-3xl mx-auto w-full z-10 space-y-1">
