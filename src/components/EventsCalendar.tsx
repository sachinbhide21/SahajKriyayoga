...
export const EventsCalendar: React.FC = () => {
  ...
  return (
    <section id="events" className="py-20 bg-[#F5F0EB] transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-bold transition-colors ${
                activeCategory === cat
                  ...
                  : 'bg-white text-slate-700 hover:bg-amber-100 :bg-slate-700'
              }`}
            >
              {cat}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {filteredEvents.map((event) => (
            <div
              key={event.id}
              className="bg-white rounded-3xl p-7 shadow-lg border border-amber-200/60 hover:border-amber-400 transition-all duration-300 flex flex-col justify-between"
            >
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1.5 text-xs font-bold text-amber-800 bg-amber-50 px-3 py-1 rounded-lg border border-amber-200/50">
                ...
                {/* Specs */}
                <div className="space-y-2 pt-3 border-t border-amber-100 text-xs text-slate-700 ">
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 ">
                <button
                  ...
                  className="w-full py-3 rounded-2xl text-xs font-bold uppercase tracking-wider text-slate-800 bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-800 shadow-md transition-all text-center"
                >
