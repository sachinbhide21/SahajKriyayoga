...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-[#FAF8F5] dark:bg-slate-900 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-8 shadow-xl border border-amber-200/60 dark:border-slate-700 space-y-5">
              <h3 className="font-serif font-bold text-xl text-slate-900 dark:text-amber-100 border-b border-amber-100 dark:border-slate-700 pb-3">
                Main Ashram Office
              </h3>
              ...
              <div className="space-y-4 text-xs sm:text-sm text-slate-700 dark:text-slate-300">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <strong className="block text-slate-900 dark:text-amber-200 font-bold">Address:</strong>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <strong className="block text-slate-900 dark:text-amber-200 font-bold">Phone / WhatsApp:</strong>
                    <a href={`tel:${ASHRAM_INFO.headquarters.phone}`} className="text-amber-700 dark:text-amber-400 font-bold hover:underline">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <strong className="block text-slate-900 dark:text-amber-200 font-bold">Email:</strong>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <strong className="block text-slate-900 dark:text-amber-200 font-bold">Satsang & Visiting Hours:</strong>
            ...
            {/* How to Reach Card */}
            <div className="bg-amber-950 text-amber-100 rounded-3xl p-6 border border-amber-800 space-y-2 text-xs">
          ...
          {/* Contact Form Right */}
          <div className="lg:col-span-7 bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-10 shadow-xl border border-amber-200/60 dark:border-slate-700">
            {!formSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-amber-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white"
                    />
                  </div>
                ...
                <div className="text-xs">
                  <label className="block font-bold text-slate-700 dark:text-slate-300 mb-1">Your Message / Query *</label>
                  <textarea
                    required
                    rows={4}
