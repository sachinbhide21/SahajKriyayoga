...
export const PresentGuruSection: React.FC = () => {
  ...
  return (
    <section id="present-guru" className="py-20 bg-[#FAF8F5] dark:bg-slate-900 transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white dark:bg-slate-800 rounded-3xl p-6 sm:p-10 shadow-xl border border-amber-200/60 dark:border-slate-700">
          ...
          <div className="lg:col-span-5 text-center">
            <div className="relative inline-block mx-auto">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-300/80 dark:border-slate-700 w-full max-w-sm mx-auto">
                <img
                ...
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-slate-950 via-slate-950/70 to-transparent p-4 text-center text-white">
                  <p className="font-serif font-bold text-lg text-amber-200">{presentGuru.name}</p>
                  <p className="text-xs text-amber-300/90">Present Acharya • Satyananda Sannyas Ashram</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent border-l-4 border-amber-600 dark:border-amber-400 space-y-3">
              ...
              <p className="text-2xl sm:text-3xl font-serif font-extrabold text-amber-950 dark:text-amber-100 tracking-wide">
                "{ASHRAM_INFO.guidingMessage}"
              </p>
              <p className="text-sm font-quote italic text-slate-700 dark:text-slate-300">
            ...
            <div className="space-y-3">
              <h4 className="font-serif font-bold text-slate-900 dark:text-amber-200 text-sm uppercase tracking-wider">
                Core Teachings & Spiritual Expositions
              </h4>

              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-xs font-semibold">
                <div className="p-3 rounded-xl bg-amber-50 dark:bg-slate-700/60 border border-amber-200/60 dark:border-slate-600 text-amber-950 dark:text-amber-100 flex items-center space-x-2">
