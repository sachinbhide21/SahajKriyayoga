...
export const FAQSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-[#F5F0EB] transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-8 max-w-lg mx-auto">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 rounded-full border border-amber-300 bg-white text-xs text-slate-900 shadow-sm"
          />
        </div>
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full text-left p-5 flex items-center justify-between font-serif font-bold text-sm sm:text-base text-slate-900 hover:text-amber-700 transition-colors"
                >
